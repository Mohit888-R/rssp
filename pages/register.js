            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 border'>
                ...
                <div className=''>
                    ...
                    <form className='py-8 px-8 space-y-4'>
                        <Select type="text" placeholder="Select Country" options={countryList} >Country</Select>
                        <Select type="text" placeholder="Select State" options={stateList} >State</Select>
                        <Select type="text" placeholder="Select District" options={DistrictList} >District</Select>
                        <br></br>
                        <p className='font-bold '>Are You : </p>
                        ...
                        <Input
                            type="email"
                            placeholder="Please Enter dedicated email"
                        >
                            Email
                        </Input>
                        <Input
                            type="number"
                            placeholder="Please enter dedicated mobile number"
                        >
                            Phone Number
                        </Input>
                        ...
                        {/* <Select type="text" placeholder="Select City" options={cityList} >City</Select> */}
